...
export const SENZAIS = [
  ...
  },
  {
    label: '想刻系列',
    options: [
      { value: /^想刻魔法：反擊/, label: '想刻魔法：反擊【敵方行動反擊】' },
      { value: /^想刻魔法：會心/, label: '想刻魔法：會心【答題必爆】' },
      { value: /^想刻魔法：金剛/, label: '想刻魔法：金剛【部份受到傷害&效果無效】' },
      { value: /^真名想刻：反擊/, label: '真名想刻：反擊【敵方行動反擊】' },
      { value: /^真名想刻：會心/, label: '真名想刻：會心【答題必爆】' },
      { value: /^真名想刻：金剛/, label: '真名想刻：金剛【部份受到傷害&效果無效】' },
    ],
  },
];

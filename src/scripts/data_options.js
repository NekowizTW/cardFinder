...
export const exasType = [
  { value: '_保留問題類型', label: '保留問題類型', disabled: true},
  { value: "保留問題類型", label: "保留問題類型" },
  { value: "保留問題類型‧獅子奮迅‧起死回生", label: "保留問題類型‧獅子奮迅‧起死回生" },
  { value: '_傷害減免', label: '傷害減免', disabled: true},
  { value: "傷害減免‧回復", label: "傷害減免‧回復" },
  { value: "傷害減免・反擊", label: "傷害減免・反擊" },
  { value: "傷害減免・連鎖數反擊", label: "傷害減免・連鎖數反擊" },
  { value: "傷害減免・阻隔傷害", label: "傷害減免・阻隔傷害" },
  { value: "傷害減免・阻隔傷害・連鎖數反擊", label: "傷害減免・阻隔傷害・連鎖數反擊" },
  { value: '_全體化', label: '全體化', disabled: true},
  { value: "全體化", label: "全體化" },
  { value: "全體化‧EX強化", label: "全體化‧EX強化" },
  { value: "全體化‧保留問題類型", label: "全體化‧保留問題類型" },
  { value: "全體化‧反擊", label: "全體化‧反擊" },
  { value: "全體化‧增加連鎖數", label: "全體化‧增加連鎖數" },
  { value: "全體化‧增加連鎖數‧狀態特效", label: "全體化‧增加連鎖數‧狀態特效" },
  { value: "全體化‧屬性特效", label: "全體化‧屬性特效" },
  { value: "全體化‧瀕死攻擊", label: "全體化‧瀕死攻擊" },
  { value: "全體化‧狀態特效", label: "全體化‧狀態特效" },
  { value: "全體化‧種族特效", label: "全體化‧種族特效" },
  { value: "全體化‧貫穿", label: "全體化‧貫穿" },
  { value: "全體化‧連續化", label: "全體化‧連續化" },
  { value: "全體化‧連鎖攻擊", label: "全體化‧連鎖攻擊" },
  { value: "全體化‧阻隔傷害", label: "全體化‧阻隔傷害" },
  { value: "全體化・整合（攻擊）", label: "全體化・整合（攻擊）" },
  { value: "全體化・阻隔傷害・增加連鎖數", label: "全體化・阻隔傷害・增加連鎖數" },
  { value: "全體化・阻隔傷害・連鎖數反擊", label: "全體化・阻隔傷害・連鎖數反擊" },
  { value: '_反擊', label: '反擊', disabled: true},
  { value: "反擊", label: "反擊" },
  { value: "反擊‧全體化‧貫穿", label: "反擊‧全體化‧貫穿" },
  { value: "反擊‧回復", label: "反擊‧回復" },
  { value: "反擊‧增加連鎖數", label: "反擊‧增加連鎖數" },
  { value: "反擊‧起死回生", label: "反擊‧起死回生" },
  { value: "反擊‧阻隔傷害", label: "反擊‧阻隔傷害" },
  { value: '_回復', label: '回復', disabled: true},
  { value: "回復", label: "回復" },
  { value: "回復‧增加連鎖數", label: "回復‧增加連鎖數" },
  { value: "回復‧強化攻擊", label: "回復‧強化攻擊" },
  { value: "回復‧防禦", label: "回復‧防禦" },
  { value: "回復‧阻隔傷害", label: "回復‧阻隔傷害" },
  { value: "回復・阻隔傷害", label: "回復・阻隔傷害" },
  { value: '_增加連鎖數', label: '增加連鎖數', disabled: true},
  { value: "增加連鎖數", label: "增加連鎖數" },
  { value: "增加連鎖數‧EX強化", label: "增加連鎖數‧EX強化" },
  { value: "增加連鎖數‧連鎖數反擊", label: "增加連鎖數‧連鎖數反擊" },
  { value: "增加連鎖數・EX強化・狀態特效", label: "增加連鎖數・EX強化・狀態特效" },
  { value: '_強化攻擊', label: '強化攻擊', disabled: true},
  { value: "強化攻擊", label: "強化攻擊" },
  { value: "強化攻擊‧反擊", label: "強化攻擊‧反擊" },
  { value: "強化攻擊‧連續化", label: "強化攻擊‧連續化" },
  { value: "強化攻擊‧防禦", label: "強化攻擊‧防禦" },
  { value: "強化攻擊‧阻隔傷害", label: "強化攻擊‧阻隔傷害" },
  { value: "強化種族攻擊‧EX強化", label: "強化種族攻擊‧EX強化" },
  { value: "強化複屬性攻擊", label: "強化複屬性攻擊" },
  { value: "強化複屬性攻擊‧起死回生", label: "強化複屬性攻擊‧起死回生" },
  { value: "強化複屬性攻擊‧阻隔傷害", label: "強化複屬性攻擊‧阻隔傷害" },
  { value: '_攻擊相關', label: '攻擊相關', disabled: true},
  { value: "攻擊", label: "攻擊" },
  { value: "攻擊‧防禦", label: "攻擊‧防禦" },
  { value: "攻擊‧阻隔傷害", label: "攻擊‧阻隔傷害" },
  { value: '_整合相關', label: '整合相關', disabled: true},
  { value: "整合（強化攻擊）", label: "整合（強化攻擊）" },
  { value: "整合（強化攻擊）‧全體化", label: "整合（強化攻擊）‧全體化" },
  { value: "整合（強化攻擊）‧增加連鎖數", label: "整合（強化攻擊）‧增加連鎖數" },
  { value: "整合（強化攻擊）・全體化", label: "整合（強化攻擊）・全體化" },
  { value: "整合（強化複屬性攻擊）", label: "整合（強化複屬性攻擊）" },
  { value: "整合（攻擊）", label: "整合（攻擊）" },
  { value: "整合（攻擊）‧增加連鎖數", label: "整合（攻擊）‧增加連鎖數" },
  { value: "整合（攻擊）・全體化", label: "整合（攻擊）・全體化" },
  { value: '_特效相關', label: '特效相關', disabled: true},
  { value: "屬性特效", label: "屬性特效" },
  { value: "屬性特效‧回復", label: "屬性特效‧回復" },
  { value: "屬性特效‧增加連鎖數", label: "屬性特效‧增加連鎖數" },
  { value: "屬性特效‧狀態特效", label: "屬性特效‧狀態特效" },
  { value: "狀態特效", label: "狀態特效" },
  { value: "狀態特效‧回復", label: "狀態特效‧回復" },
  { value: "狀態特效‧增加連鎖數", label: "狀態特效‧增加連鎖數" },
  { value: "狀態特效‧追擊", label: "狀態特效‧追擊" },
  { value: "狀態特效‧阻隔傷害", label: "狀態特效‧阻隔傷害" },
  { value: "種族特效‧狀態特效", label: "種族特效‧狀態特效" },
  { value: "_貫穿", label: "_貫穿", disabled: true },
  { value: "貫穿", label: "貫穿" },
  { value: "貫穿‧保留問題類型", label: "貫穿‧保留問題類型" },
  { value: "貫穿‧回復", label: "貫穿‧回復" },
  { value: "貫穿‧增加連鎖數", label: "貫穿‧增加連鎖數" },
  { value: "貫穿‧狀態特效", label: "貫穿‧狀態特效" },
  { value: "貫穿‧追擊", label: "貫穿‧追擊" },
  { value: "貫穿‧追擊‧反擊", label: "貫穿‧追擊‧反擊" },
  { value: "貫穿‧阻隔傷害", label: "貫穿‧阻隔傷害" },
  { value: "_起死回生", label: "_起死回生", disabled: true },
  { value: "起死回生", label: "起死回生" },
  { value: "獅子奮迅‧起死回生", label: "獅子奮迅‧起死回生" },
  { value: "_追擊", label: "_追擊", disabled: true },
  { value: "追擊", label: "追擊" },
  { value: "追擊‧狀態特效", label: "追擊‧狀態特效" },
  { value: "追擊‧起死回生", label: "追擊‧起死回生" },
  { value: "_連擊", label: "_連擊", disabled: true },
  { value: "連擊", label: "連擊" },
  { value: "連擊‧種族數攻擊", label: "連擊‧種族數攻擊" },
  { value: "連擊‧阻隔傷害‧起死回生", label: "連擊‧阻隔傷害‧起死回生" },
  { value: "_連續化", label: "_連續化", disabled: true },
  { value: "連續化", label: "連續化" },
  { value: "連續化‧全體化", label: "連續化‧全體化" },
  { value: "連續化‧全體化‧阻隔傷害", label: "連續化‧全體化‧阻隔傷害" },
  { value: "連續化‧增加連鎖數", label: "連續化‧增加連鎖數" },
  { value: "連續化‧屬性特效", label: "連續化‧屬性特效" },
  { value: "連續化‧強化攻擊", label: "連續化‧強化攻擊" },
  { value: "連續化‧強化種族攻擊", label: "連續化‧強化種族攻擊" },
  { value: "連續化‧強化複屬性攻擊", label: "連續化‧強化複屬性攻擊" },
  { value: "連續化‧狀態特效", label: "連續化‧狀態特效" },
  { value: "連續化‧精神抖擻攻擊", label: "連續化‧精神抖擻攻擊" },
  { value: "連續化‧貫穿", label: "連續化‧貫穿" },
  { value: "連續化‧貫穿‧增加連鎖數", label: "連續化‧貫穿‧增加連鎖數" },
  { value: "連續化‧追擊", label: "連續化‧追擊" },
  { value: "連續化‧防禦", label: "連續化‧防禦" },
  { value: "連續化‧防禦‧瀕死攻擊", label: "連續化‧防禦‧瀕死攻擊" },
  { value: "連續化・整合（攻擊）", label: "連續化・整合（攻擊）" },
  { value: "連續化・起死回生・增加連鎖數", label: "連續化・起死回生・增加連鎖數" },
  { value: "_連鎖數反擊", label: "_連鎖數反擊", disabled: true },
  { value: "連鎖數反擊", label: "連鎖數反擊" },
  { value: "_防禦", label: "_防禦", disabled: true },
  { value: "防禦", label: "防禦" },
  { value: "防禦‧反擊", label: "防禦‧反擊" },
  { value: "防禦‧回復", label: "防禦‧回復" },
  { value: "防禦‧增加連鎖數", label: "防禦‧增加連鎖數" },
  { value: "防禦‧狀態特效", label: "防禦‧狀態特效" },
  { value: "防禦‧貫穿", label: "防禦‧貫穿" },
  { value: "防禦‧追擊", label: "防禦‧追擊" },
  { value: "防禦‧阻隔傷害", label: "防禦‧阻隔傷害" },
  { value: "_阻隔傷害", label: "_阻隔傷害", disabled: true },
  { value: "阻隔傷害", label: "阻隔傷害" },
  { value: "阻隔傷害‧EX強化", label: "阻隔傷害‧EX強化" },
  { value: "阻隔傷害‧保留問題類型", label: "阻隔傷害‧保留問題類型" },
  { value: "阻隔傷害‧增加連鎖數", label: "阻隔傷害‧增加連鎖數" },
  { value: "阻隔傷害‧起死回生", label: "阻隔傷害‧起死回生" },
  { value: "阻隔傷害・起死回生・反擊", label: "阻隔傷害・起死回生・反擊" }
];
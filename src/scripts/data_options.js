...
export const SKILL_AS = [
  ...
  { value: '攻擊上升', label: '攻擊上升'},
  { value: '連段數攻擊上升', label: '連段數攻擊上升'},
  { value: '連段數攻擊上升＆種族攻擊上升', label: '連段數攻擊上升＆種族攻擊上升'},
  { value: '連段數攻擊上升＆隊友攻擊上升', label: '連段數攻擊上升＆隊友攻擊上升'},
  { value: '瀕死攻擊上升', label: '瀕死攻擊上升'},
  { value: '快調攻擊上升', label: '快調攻擊上升'},
  { value: '問題屬性攻擊上升', label: '問題屬性攻擊上升'},
  { value: '種族攻擊上升/自身', label: '種族攻擊上升/自身'},
  { value: '失去的憤怒', label: '失去的憤怒(依己方陣亡數增加傷害)'},
  { value: '賭博攻擊', label: '賭博攻擊'},
  { value: '_隊伍攻擊上升系', label: '隊伍攻擊上升', disabled: true},
  { value: '攻擊上升/隊友', label: '攻擊上升/隊友'},
  { value: '種族攻擊上升', label: '指定種族攻擊上升'},
  ...
  { value: '種族特攻/額外增傷', label: '種族特攻/額外增傷'},
  { value: '_全體攻擊系', label: '全體攻擊系', disabled: true},
  { value: '全體攻擊/分散', label: '全體攻擊/分散'},
  { value: '全體攻擊/不分散', label: '全體攻擊/不分散'},
  { value: '種族特攻/不分散全體攻擊', label: '種族特攻/不分散全體攻擊'},
  { value: '_回復系', label: '回復系', disabled: true},
  { value: '回復/自身', label: '回復/自身'},
  { value: '回復', label: '回復'},
  { value: '回復＆減輕傷害', label: '回復＆減輕傷害'},
  { value: '連段數回復', label: '連段數回復'},
  { value: '_其他', label: '其他', disabled: true},
  { value: '吸收', label: '吸收'},
  { value: '屬性的庇佑', label: '屬性的庇佑(依隊伍屬性數提升攻擊力)'},
  { value: '減輕傷害', label: '減輕傷害'},
  { value: '無', label: '無技能'}
];
export const SKILL_AS2 = [
  { value: '_自身攻擊上升系', label: '自身攻擊上升', disabled: true},
  { value: '攻擊上升', label: '攻擊上升'},
  { value: '攻擊上升＆回復', label: '攻擊上升＆回復'},
  { value: '連段數攻擊上升', label: '連段數攻擊上升'},
  { value: '連段數攻擊上升＆種族攻擊上升', label: '連段數攻擊上升＆種族攻擊上升'},
  { value: '連段數攻擊上升＆隊友攻擊上升', label: '連段數攻擊上升＆隊友攻擊上升'},
  { value: '連段數攻擊上升＆回復', label: '連段數攻擊上升＆回復'},
  { value: '瀕死攻擊上升', label: '瀕死攻擊上升'},
  { value: '快調攻擊上升', label: '快調攻擊上升'},
  { value: '問題屬性攻擊上升', label: '問題屬性攻擊上升'},
  { value: '種族攻擊上升/自身', label: '種族攻擊上升/自身'},
  ...
  { value: '_隊伍攻擊上升系', label: '隊伍攻擊上升', disabled: true},
  { value: '攻擊上升/隊友', label: '攻擊上升/隊友'},
  { value: '隊友攻擊上升＆回復', label: '隊友攻擊上升＆回復'},
  { value: '種族攻擊上升', label: '種族攻擊上升'},
  { value: '種族攻擊上升＆隊友攻擊上升', label: '種族攻擊上升＆隊友攻擊上升'},
  { value: '_連擊系', label: '連擊系', disabled: true},
  { value: '連擊', label: '連擊'},
  { value: '_特效系', label: '特效系', disabled: true},
  { value: '屬性特效', label: '屬性特效'},
  ...
  { value: '連段數回復', label: '連段數回復'},
  { value: '回復＆減輕傷害', label: '回復＆減輕傷害'},
  { value: '回復＆隊友攻擊上升', label: '回復＆隊友攻擊上升'},
  { value: '_其他', label: '其他', disabled: true},
  { value: '吸收', label: '吸收'},
  { value: '屬性的庇佑', label: '屬性的庇佑(依隊伍屬性數提升攻擊力)'},
  { value: '減輕傷害', label: '減輕傷害'},
...
export const SKILL_SS = [
  ...
  { value: '效果解除/防禦＆阻隔傷害/單體', label: '效果解除/防禦＆阻隔傷害/單體'},
...
export const SKILL_SS2 = [
  ...
  { value: '效果解除大魔術/物理反擊＆技能反彈', label: '效果解除大魔術/物理反擊＆技能反彈'},
  { value: '效果解除/防禦＆阻隔傷害', label: '效果解除/防禦＆阻隔傷害'},
  { value: '效果解除大魔術/防禦＆阻隔傷害', label: '效果解除大魔術/防禦＆阻隔傷害'},
  { value: '效果解除大魔術/防禦＆阻隔傷害/單體', label: '效果解除大魔術/防禦＆阻隔傷害/單體'},
  { value: '效果解除大魔術/防禦＆阻隔傷害＆技能反彈', label: '效果解除大魔術/防禦＆阻隔傷害＆技能反彈'},
  { value: '_回復相關', label: '回復相關', disabled: true},
  { value: '回復', label: '回復'},
  { value: '持續回復', label: '持續回復(徐徐回復)'},
...
export const ZZ = [
  ...
  { value: '心眼', label: '心眼'},
  { value: 'AS技能封印失效', label: 'AS技能封印失效'},
  { value: 'SS封印無效', label: 'SS封印無效'},
  { value: '毒攻擊失效', label: '毒攻擊失效'}
];
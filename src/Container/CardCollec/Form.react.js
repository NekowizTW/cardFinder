...
function optionRestore (paramSource, options) {
  let params = Object.assign({ filterText: '' }, paramSource);
  let filter = {};
    ...
    return <div id="CardCollecForm">
      <div className={'pure-form pure-g'}>
        <TextFilter
          ...
          placeholder={'請輸入卡片編號或卡片名字'} className={'pure-u-5-6'}
        />
        <button
          type='button'
            ...
            <ul className={'pure-menu-list'}>
              {
                props.panes.map(pane => {
                  ...
                  return <li className={itemClass} key={pane.key}>
                    <a href={'#'} className={'pure-menu-link'} onClick={(a) => {
      ...
      >
        <TabPane tab='基本屬性' key='0'>
           <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('props')}
          />
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('props2')}
          />
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('breeds')}
          />
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('ranks')}
          />
        </TabPane>
        <TabPane tab='答題技能' key='1'>
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('as')}
          />
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('as2')}
          />
        </TabPane>
        <TabPane tab='特殊技能' key='2'>
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('ss')}
          />
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('ss2')}
          />
        </TabPane>
        <TabPane tab='潛能/L發動能力' key='3'>
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('zz')}
          />
        </TabPane>
        <TabPane tab='EXAS' key='4'>
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('exasCondition')}
          />
          <Select
            ...
            isMulti onChange={this.filterChange.bind(this)('exasType')}
          />
        </TabPane>
        </Tabs>

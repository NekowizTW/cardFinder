import ButtonLogClass, { styleValue } from 'blm-log/es';
...
export function logDebug(name, obj, debug = false) {
  ...
  const buttonLog = new ButtonLogClass({
    logBy: 'CalculateHelper', // log 第一個按鈕中的文字內容
    logName: name, // log 第二個按鈕中的文字內容
    preButtonColor: styleValue.MATERIAL_DEEP_CYAN, // 第一個按鈕顏色
    nextButtonColor: styleValue.MATERIAL_DEEP_GREEN, // 第二個按鈕顏色
    padding: 6, // 單位 px，決定了 button 的大小
    borderRadius: 1, // 單位 px
    fontColor: '#fff', // 字體顏色
  });
